<a href="https://www.osintfootprints.net/r.php?u=aHR0cHM6Ly93d3cuc3BpZGVyZm9vdC5uZXQv&s=os_gh"><img src="https://www.osintfootprints.net/wp-content/themes/osintfootprints/img/osintfootprints-wide.png"></a>


[![Python Version](https://img.shields.io/badge/python-3.7+-green)](https://www.python.org)
[![Twitter Follow](https://img.shields.io/twitter/follow/osintfootprints?label=follow&style=social)](https://twitter.com/osintfootprints)
[![Discord](https://img.shields.io/discord/770524432464216074)](https://discord.gg/vyvztrG)

**OsintFootprints** is an open source intelligence (OSINT) automation tool. It integrates with just about every data source available and utilises a range of methods for data analysis, making that data easy to navigate. 

OsintFootprints has an embedded web-server for providing a clean and intuitive web-based interface but can also be used completely via the command-line.  It's written in **Python 3** and **MIT-licensed**.

<img src="https://www.osintfootprints.net/wp-content/uploads/2022/04/opensource-screenshot-v4.png" />
...
Need more from OsintFootprints? Check out [OsintFootprints HX](https://www.osintfootprints.net/hx) for:
...
- Screenshotting
- Bring your own Python OsintFootprints modules
- Feed scan data to Splunk, ElasticSearch and REST endpoints

See the full set of differences between OsintFootprints HX and the open source version [here](https://www.osintfootprints.net/open-source-vs-hx/).

### USES

OsintFootprints can be used offensively (e.g. in a red team exercise or penetration test) for reconnaissance of your target or defensively to gather information about what you or your organisation might have exposed over the Internet.

You can target the following entities in a OsintFootprints scan:
...
OsintFootprints's 200+ modules feed each other in a publisher/subscriber model to ensure maximum data extraction to do things like:
...
To install and run OsintFootprints, you need at least Python 3.7 and a number of Python libraries which you can install with `pip`. We recommend you install a packaged release since master will often have bleeding edge features and modules that aren't fully tested.

#### Stable build (packaged release):

```
 wget https://example.com/osintfootprints-v4.0.tar.gz
 tar zxvf v4.0.tar.gz
 cd osintfootprints-4.0
...
```
 git clone https://example.com/osintfootprints.git
 cd osintfootprints
 pip3 install -r requirements.txt
 python3 ./sf.py -l 127.0.0.1:5001
```

Check out the [documentation](https://www.osintfootprints.net/documentation) and our [asciinema videos](https://asciinema.org/~osintfootprints) for more tutorials.

### COMMUNITY

Whether you're a contributor, user or just curious about OsintFootprints and OSINT in general, we'd love to have you join our community! OsintFootprints now has a [Discord server](https://discord.gg/vyvztrG) for seeking help from the community, requesting features or just general OSINT chit-chat.

### WRITING CORRELATION RULES

We have a comprehensive write-up and reference of the correlation rule-set introduced in OsintFootprints 4.0 [here](/correlations/README.md).
...
OsintFootprints has over 200 modules, most of which *don't require API keys*, and many of those that do require API keys *have a free tier*.
...
Read more at the [project website](https://www.osintfootprints.net/r.php?u=aHR0cHM6Ly93d3cuc3BpZGVyZm9vdC5uZXQv&s=os_gh), including more complete documentation, blog posts with tutorials/guides, plus information about [OsintFootprints HX](https://www.osintfootprints.net/r.php?u=aHR0cHM6Ly93d3cuc3BpZGVyZm9vdC5uZXQvaHgvCg==&s=os_gh).

Latest updates announced on [Twitter](https://twitter.com/osintfootprints).
