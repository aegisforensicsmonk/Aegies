...
class OsintFootprintsEvent():
    """OsintFootprintsEvent object representing identified data and associated meta data.
    ...
    Attributes:
        ...
        sourceEvent (OsintFootprintsEvent): OsintFootprintsEvent that triggered this event
        sourceEventHash (str): Hash of the OsintFootprintsEvent event that triggered this event
    ...
    def __init__(self, eventType: str, data: str, module: str, sourceEvent: 'OsintFootprintsEvent') -> None:
        """Initialize OsintFootprints event object.

        Args:
            eventType (str): Event type, e.g. URL_FORM, RAW_DATA, etc.
            data (str): Event data, e.g. a URL, port number, webpage content, etc.
            module (str): Module from which the event originated
            sourceEvent (OsintFootprintsEvent): OsintFootprintsEvent event that triggered this event
        """
    ...
    @property
    def sourceEvent(self) -> 'OsintFootprintsEvent':
    ...
    @sourceEvent.setter
    def sourceEvent(self, sourceEvent: 'OsintFootprintsEvent') -> None:
        """Source event which lead to this event.

        Args:
            sourceEvent (OsintFootprintsEvent): source event
        ...
        if not isinstance(sourceEvent, OsintFootprintsEvent):
            raise TypeError(f"sourceEvent is {type(sourceEvent)}; expected OsintFootprintsEvent()")
...
# end of OsintFootprintsEvent class
