# -------------------------------------------------------------------------------
# Name:        sfp_numverify
# Purpose:     OsintFootprints plug-in to search numverify.com API for a phone number
...
class sfp_numverify(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if data.get('country_code'):
            country = OsintFootprintsHelpers.countryNameFromCountryCode(data.get('country_code'))
        ...
        if data.get('carrier'):
            evt = OsintFootprintsEvent("PROVIDER_TELCO", data.get('carrier'), self.__name__, event)
            self.notifyListeners(evt)
        else:
