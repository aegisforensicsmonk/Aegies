...
class sfp_ahmia(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for link in links:
            ...
            if not self.opts['fetchlinks']:
                evt = OsintFootprintsEvent("DARKNET_MENTION_URL", link, self.__name__, event)
            ...
            evt = OsintFootprintsEvent("DARKNET_MENTION_CONTENT", f"...{wdata}...", self.__name__, evt)
            self.notifyListeners(evt)
