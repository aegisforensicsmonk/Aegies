...
# -------------------------------------------------------------------------------
# Name:         sfp_onyphe
# Purpose:      OsintFootprints plug-in to check if the IP is included on Onyphe
...
class sfp_onyphe(OsintFootprintsPlugin):
    ...
    def emitLocationEvent(self, location, eventData, event):
        ...
        evt = OsintFootprintsEvent("PHYSICAL_COORDINATES", location, self.__name__, event)
    ...
    def emitDomainData(self, response, eventData, event):
        ...
        for domain in domains:
            ...
            if self.cohostcount < self.opts['maxcohost']:
                ...
                evt = OsintFootprintsEvent("CO_HOSTED_SITE", domain, self.__name__, event)
                self.notifyListeners(evt)
                self.cohostcount += 1
