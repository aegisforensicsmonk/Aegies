...
# -------------------------------------------------------------------------------
# Name:        sfp_surbl
# Purpose:     OsintFootprints plug-in to check whether IP addresses, netblocks, and
...
class sfp_surbl(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            for result in res:
                ...
                evt = OsintFootprintsEvent(blacklist_type, f"SURBL [{addr}]", self.__name__, event)
                self.notifyListeners(evt)

                evt = OsintFootprintsEvent(malicious_type, f"SURBL [{addr}]", self.__name__, event)
                self.notifyListeners(evt)
