...
# -------------------------------------------------------------------------------
# Name:         sfp_botscout
# Purpose:      OsintFootprints plug-in to search botsout.com using their API, for
...
class sfp_botscout(OsintFootprintsPlugin):
    ...
    def queryEmail(self, email):
        if not OsintFootprintsHelpers.validEmail(email):
            return None
    ...
    def handleEvent(self, event):
        ...
        if eventName == "IP_ADDRESS":
            ...
            evt = OsintFootprintsEvent("MALICIOUS_IPADDR", text, self.__name__, event)
            self.notifyListeners(evt)

            evt = OsintFootprintsEvent("BLACKLISTED_IPADDR", text, self.__name__, event)
            self.notifyListeners(evt)
            ...
            evt = OsintFootprintsEvent("MALICIOUS_EMAILADDR", text, self.__name__, event)
            self.notifyListeners(evt)
        else:
