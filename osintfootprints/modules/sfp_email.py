...
class sfp_email(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        emails = OsintFootprintsHelpers.extractEmailsFromText(eventData)
        for email in set(emails):
            ...
            evt = OsintFootprintsEvent(evttype, mail, self.__name__, event)
