...
class sfp_arin(OsintFootprintsPlugin):
    ...
    def query(self, qtype, value):
        ...
        evt = OsintFootprintsEvent("RAW_RIR_DATA", str(data), self.__name__, self.currentEventSrc)
            ...
            if "pocs" in ret:
                if "pocRef" in ret['pocs']:
                    ...
                    for p in ref:
                        ...
                        evt = OsintFootprintsEvent("HUMAN_NAME", name,
