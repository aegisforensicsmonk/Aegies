...
class sfp_subdomain_takeover(OsintFootprintsPlugin):
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        if content is None:
            ...
            res = self.sf.fetchUrl(url, useragent="OsintFootprints")
                    ...
                    for proto in ["https", "http"]:
                        ...
                        for fingerprint in fingerprints:
                            if fingerprint in res['content']:
                                ...
                                evt = OsintFootprintsEvent("AFFILIATE_INTERNET_NAME_HIJACKABLE", eventData, self.__name__, event)
