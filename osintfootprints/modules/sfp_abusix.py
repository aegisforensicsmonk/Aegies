...
class sfp_abusix(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            for result in res:
                ...
                evt = OsintFootprintsEvent(blacklist_type, text, self.__name__, event)
                self.notifyListeners(evt)

                evt = OsintFootprintsEvent(malicious_type, text, self.__name__, event)
                self.notifyListeners(evt)
