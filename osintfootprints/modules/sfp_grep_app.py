...
class sfp_grep_app(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        while page <= pages:
            ...
            for result in data:
                ...
                evt = OsintFootprintsEvent("RAW_RIR_DATA", str(result), self.__name__, event)
                ...
                emails = OsintFootprintsHelpers.extractEmailsFromText(snippet.replace('<mark>', '').replace('</mark>', ''))
                if emails:
                    for email in emails:
