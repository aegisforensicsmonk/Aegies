...
class sfp_psbdmp(OsintFootprintsPlugin):
    ...
    def query(self, qry):
        ...
        res = self.sf.fetchUrl(url, timeout=15, useragent="OsintFootprints")
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            e = OsintFootprintsEvent("LEAKSITE_URL", n, self.__name__, event)
            ...
            evt = OsintFootprintsEvent("LEAKSITE_CONTENT", res['content'], self.__name__, e)
