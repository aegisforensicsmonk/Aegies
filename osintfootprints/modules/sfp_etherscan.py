...
# -------------------------------------------------------------------------------
# Name:         sfp_etherscan
# Purpose:      OsintFootprints plug-in to look up a ethereum wallet's balance by
...
class sfp_etherscan(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        evt = OsintFootprintsEvent("ETHEREUM_BALANCE", f"{str(balance)} ETH", self.__name__, event)
