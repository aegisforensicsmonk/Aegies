...
# -------------------------------------------------------------------------------
# Name:        sfp_phishstats
# Purpose:     Osintfootprints plugin to search PhishStats API
...
class sfp_phishstats(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            evt = OsintFootprintsEvent("RAW_RIR_DATA", str(data), self.__name__, pevent)
            self.notifyListeners(evt)

            text = f"PhishStats [{addr}]"

            evt = OsintFootprintsEvent(blacklist_type, text, self.__name__, pevent)
            self.notifyListeners(evt)

            evt = OsintFootprintsEvent(malicious_type, text, self.__name__, pevent)
            self.notifyListeners(evt)
