...
class sfp_fullhunt(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        e = OsintFootprintsEvent("RAW_RIR_DATA", str(res), self.__name__, event)
        ...
        for record in res:
            ...
            if network_ports:
                for port in network_ports:
                    e = OsintFootprintsEvent("TCP_PORT_OPEN", f"{host}:{port}", self.__name__, event)
                    self.notifyListeners(e)
        ...
        for host in set(mail_servers):
            ...
            e = OsintFootprintsEvent("PROVIDER_MAIL", host, self.__name__, event)
            self.notifyListeners(e)
        ...
        for host in set(name_servers):
            ...
            e = OsintFootprintsEvent("PROVIDER_DNS", host, self.__name__, event)
            self.notifyListeners(e)
