...
# -------------------------------------------------------------------------------
# Name:        sfp_citadel
# Purpose:     OsintFootprints plug-in to search Leak-Lookup using their API,
...
class sfp_citadel(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for site in message:
            ...
            evt = OsintFootprintsEvent("EMAILADDR_COMPROMISED", f"{eventData} [{site}]", self.__name__, event)
