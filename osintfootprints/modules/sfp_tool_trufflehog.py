...
# Purpose:     OsintFootprints plug-in for using the trufflehog tool.
...
from osintfootprints import OsintFootprintsPlugin, OsintFootprintsEvent


class sfp_tool_trufflehog(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for row in stdout.split("\n"):
            ...
            evt = OsintFootprintsEvent('PASSWORD_COMPROMISED', descr, self.__name__, event)
