...
# Purpose:      OsintFootprints plug-in for retrieving e-mail addresses
...
class sfp_emailformat(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        emails = OsintFootprintsHelpers.extractEmailsFromText(data)
        for email in emails:
