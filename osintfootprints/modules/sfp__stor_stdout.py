...
# Purpose:      OsintFootprints plug-in for dumping events to standard output.
#
...
from osintfootprints import OsintFootprintsPlugin


class sfp__stor_stdout(OsintFootprintsPlugin):

    meta = {
        'name': "Command-line output",
        'summary': "Dumps output to standard out. Used for when a OsintFootprints scan is run via the command-line."
    }
