...
# -------------------------------------------------------------------------------
# Name:         sfp_crossref
# Purpose:      OsintFootprints plug-in for scanning links identified from the
...
class sfp_crossref(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if not matched:
            ...
            if eventName == "LINKED_URL_EXTERNAL" and self.opts['checkbase']:
                ...
                url = OsintFootprintsHelpers.urlBaseUrl(eventData)
