...
# -------------------------------------------------------------------------------
# Name:         sfp_tldsearch
# Purpose:      OsintFootprints plug-in for identifying the existence of this target
#               on other TLDs.
#
...
class sfp_tldsearch(OsintFootprintsPlugin):
    ...
    def sendEvent(self, source, result):
        ...
        if self.opts['activeonly']:
            ...
            if pageContent['content'] is not None:
                evt = OsintFootprintsEvent("SIMILARDOMAIN", result, self.__name__, source)
