...
class sfp_abstractapi(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName == "DOMAIN_NAME":
            ...
            e = OsintFootprintsEvent("RAW_RIR_DATA", str(data), self.__name__, event)
            self.notifyListeners(e)

            e = OsintFootprintsEvent("COMPANY_NAME", name, self.__name__, event)
            self.notifyListeners(e)
            ...
            if linkedin_url:
                ...
                e = OsintFootprintsEvent("SOCIAL_MEDIA", f"LinkedIn (Company): <SFURL>{linkedin_url}</SFURL>", self.__name__, event)
                self.notifyListeners(e)
            ...
            if geoinfo:
                e = OsintFootprintsEvent("GEOINFO", geoinfo, self.__name__, event)
                self.notifyListeners(e)
            ...
            if carrier:
                e = OsintFootprintsEvent("PROVIDER_TELCO", carrier, self.__name__, event)
                self.notifyListeners(e)
            ...
            if latitude and longitude:
                e = OsintFootprintsEvent("PHYSICAL_COORDINATES", f"{latitude}, {longitude}", self.__name__, event)
                self.notifyListeners(e)
