...
class sfp_venmo(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if display_name:
            evt = OsintFootprintsEvent('HUMAN_NAME', display_name, self.__name__, event)
            self.notifyListeners(evt)

            evt = OsintFootprintsEvent('RAW_RIR_DATA', str(data),
                                  self.__name__, event)
            self.notifyListeners(evt)
