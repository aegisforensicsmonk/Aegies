...
# Purpose:      OsintFootprints plug-in for identifying non-standard HTTP headers
...
class sfp_strangeheaders(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for key in data:
            if key.lower() not in headers:
                evt = OsintFootprintsEvent("WEBSERVER_STRANGEHEADER", f"{key}: {data[key]}", self.__name__, event)
