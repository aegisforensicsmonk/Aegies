...
class sfp_comodo(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        evt = OsintFootprintsEvent(blacklist_type, f"Comodo Secure DNS [{eventData}]", self.__name__, event)
        self.notifyListeners(evt)

        evt = OsintFootprintsEvent(malicious_type, f"Comodo Secure DNS [{eventData}]", self.__name__, event)
        self.notifyListeners(evt)
