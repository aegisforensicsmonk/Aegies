...
class sfp_duckduckgo(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if abstract_text:
            ...
            evt = OsintFootprintsEvent(event_type, str(abstract_text), self.__name__, event)
        ...
        if related_topics:
            ...
            for topic in related_topics:
                ...
                evt = OsintFootprintsEvent(event_type, category, self.__name__, event)
                self.notifyListeners(evt)
