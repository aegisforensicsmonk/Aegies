...
# Purpose:      OsintFootprints plug-in to check if the URL is included on any of the
...
class sfp_googlesafebrowsing(OsintFootprintsPlugin):
    ...
    def query(self, qry):
        ...
        payload = {
            "client": {"clientId": "OsintFootprints", "clientVersion": "3.2"},
            "threatInfo": {
                "threatTypes": [
