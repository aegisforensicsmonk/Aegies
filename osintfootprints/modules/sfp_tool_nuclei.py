...
# Purpose:      OsintFootprints plug-in for using the 'Nuclei' tool.
...
class sfp_tool_nuclei(OsintFootprintsPlugin):
        ...
        try:
            for line in content.split("\n"):
                ...
                if host != eventData:
                    ...
                    srcevent = OsintFootprintsEvent(srctype, host, self.__name__, event)
