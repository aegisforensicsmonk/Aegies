...
# -------------------------------------------------------------------------------
# Name:         sfp_ipapicom
# Purpose:      OsintFootprints plug-in to identify the Geo-location of IP addresses
...
class sfp_ipapicom(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if data.get('country_name'):
            ...
            if data.get('latitude') and data.get('longitude'):
                evt = OsintFootprintsEvent("PHYSICAL_COORDINATES", f"{data.get('latitude')}, {data.get('longitude')}", self.__name__, event)
                self.notifyListeners(evt)
