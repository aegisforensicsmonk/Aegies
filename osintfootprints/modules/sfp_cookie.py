...
# -------------------------------------------------------------------------------
# Name:         sfp_cookie
# Purpose:      OsintFootprints plug-in for extracting cookies from HTTP headers.
#
...
class sfp_cookie(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if cookie:
            evt = OsintFootprintsEvent("TARGET_WEB_COOKIE", cookie, self.__name__, event)
