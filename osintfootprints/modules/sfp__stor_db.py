...
# -------------------------------------------------------------------------------
# Name:         sfp_stor_db
# Purpose:      OsintFootprints plug-in for storing events to the local OsintFootprints
#               SQLite database.
#
...
class sfp__stor_db(OsintFootprintsPlugin):

    meta = {
        'name': "Storage",
        'summary': "Stores scan results into the back-end OsintFootprints database. You will need this."
    }
