...
# Purpose:      OsintFootprints plug-in to retrieve latitude/longitude coordinates
...
class sfp_openstreetmap(OsintFootprintsPlugin):
    ...
    def query(self, qry):
        ...
        res = self.sf.fetchUrl("https://nominatim.openstreetmap.org/search?" + urllib.parse.urlencode(params),
                               timeout=self.opts['_fetchtimeout'], useragent='OsintFootprints')
    ...
    def handleEvent(self, event):
        ...
        for location in data:
            ...
            evt = OsintFootprintsEvent("PHYSICAL_COORDINATES", coords, self.__name__, event)
