...
# -------------------------------------------------------------------------------
# Name:         sfp_crt
# Purpose:      OsintFootprints plug-in to identify historical certificates for a domain
...
class sfp_crt(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for cert_id in set(certs):
            ...
            if cert_text:
                evt = OsintFootprintsEvent("SSL_CERTIFICATE_RAW", str(cert_text), self.__name__, event)
                self.notifyListeners(evt)
