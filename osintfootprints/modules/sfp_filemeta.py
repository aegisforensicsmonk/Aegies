...
class sfp_filemeta(OsintFootprintsPlugin):
        ...
        for fileExt in self.opts['fileexts']:
            ...
            if "." + fileExt.lower() in eventData.lower():
                ...
                if meta is not None and data is not None:
                    rawevt = OsintFootprintsEvent("RAW_FILE_META_DATA", meta,
                                             self.__name__, event)
                    ...
                    for v in val:
                        if v and not isinstance(v, PyPDF2.generic.NullObject):
                            ...
                            evt = OsintFootprintsEvent("SOFTWARE_USED", v, self.__name__, rawevt)
