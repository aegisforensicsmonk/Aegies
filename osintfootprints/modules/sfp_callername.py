# -------------------------------------------------------------------------------
# Name:        sfp_callername
# Purpose:     OsintFootprints plug-in to search CallerName.com for a phone number
...
class sfp_callername(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if rep_good_match and rep_bad_match:
            ...
            if bad_votes > good_votes:
                ...
                evt = OsintFootprintsEvent('MALICIOUS_PHONE_NUMBER', text, self.__name__, event)
                self.notifyListeners(evt)
