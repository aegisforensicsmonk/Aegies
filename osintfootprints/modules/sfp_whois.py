...
# -------------------------------------------------------------------------------
# Name:         sfp_whois
# Purpose:      OsintFootprints plug-in for searching Whois servers for domain names
...
class sfp_whois(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        rawevt = OsintFootprintsEvent(typ, data, self.__name__, event)
        ...
        if eventName.startswith("DOMAIN_NAME"):
            if whoisdata:
                ...
                if registrar:
                    evt = OsintFootprintsEvent("DOMAIN_REGISTRAR", registrar, self.__name__, event)
