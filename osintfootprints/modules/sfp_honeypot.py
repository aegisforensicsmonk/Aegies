...
# -------------------------------------------------------------------------------
# Name:        sfp_honeypot
# Purpose:     OsintFootprints plug-in for looking up whether IPs appear in the
...
class sfp_honeypot(OsintFootprintsPlugin):
    ...
    def queryAddr(self, qaddr, parentEvent):
        ...
        evt = OsintFootprintsEvent(malicious_type, f"ProjectHoneyPot ({qaddr}): {text}\n<SFURL>{url}</SFURL>", self.__name__, parentEvent)
        self.notifyListeners(evt)

        evt = OsintFootprintsEvent(blacklist_type, f"ProjectHoneyPot ({qaddr}): {text}\n<SFURL>{url}</SFURL>", self.__name__, parentEvent)
        self.notifyListeners(evt)
