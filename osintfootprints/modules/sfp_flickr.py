...
class sfp_flickr(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        while page <= pages:
            ...
            for photo in photos.get('photo', list()):
                emails = OsintFootprintsHelpers.extractEmailsFromText(str(photo))
                for email in emails:
                ...
                links = OsintFootprintsHelpers.extractUrlsFromText(str(photo))
                for link in links:
