...
# -------------------------------------------------------------------------------
# Name:         sfp_blockchain
# Purpose:      OsintFootprints plug-in to look up a bitcoin wallet's balance by
...
class sfp_blockchain(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        evt = OsintFootprintsEvent("BITCOIN_BALANCE", str(balance) + " BTC", self.__name__, event)
