...
class sfp_names(OsintFootprintsPlugin):
    ...
    def setup(self, sfc, userOpts=dict()):
        ...
        self.d = OsintFootprintsHelpers.dictionaryWordsFromWordlists()
        self.n = OsintFootprintsHelpers.humanNamesFromWordlists()
    ...
    def handleEvent(self, event):
        ...
        if eventName == "EMAILADDR" and self.opts['emailtoname']:
            ...
            evt = OsintFootprintsEvent("HUMAN_NAME", name, self.__name__, event)
