...
class sfp_uceprotect(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            if level1:
                ...
                evt = OsintFootprintsEvent(blacklist_type, description, self.__name__, event)
                self.notifyListeners(evt)

                evt = OsintFootprintsEvent(malicious_type, description, self.__name__, event)
                self.notifyListeners(evt)
