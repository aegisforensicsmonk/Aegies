...
class sfp_slideshare(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        e = OsintFootprintsEvent("RAW_RIR_DATA", f"Possible full name: {human_name[0]}", self.__name__, event)
        ...
        e = OsintFootprintsEvent("GEOINFO", location[0], self.__name__, event)
        self.notifyListeners(e)
