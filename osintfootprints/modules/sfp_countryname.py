...
class sfp_countryname(OsintFootprintsPlugin):
    ...
    def detectCountryFromPhone(self, srcPhoneNumber: str) -> str:
        ...
        return OsintFootprintsHelpers.countryNameFromCountryCode(countryCode.upper())
    ...
    def detectCountryFromDomainName(self, srcDomain: str) -> str:
        ...
        for part in domainParts[::-1]:
            country_name = OsintFootprintsHelpers.countryNameFromTld(part)
            if country_name:
                return country_name
    ...
    def detectCountryFromIBAN(self, srcIBAN: str) -> str:
        ...
        return OsintFootprintsHelpers.countryNameFromCountryCode(srcIBAN[0:2])
    ...
    def detectCountryFromData(self, srcData: str) -> list:
        ...
        abbvCountryCodes = OsintFootprintsHelpers.countryCodes()
    ...
    def handleEvent(self, event):
        ...
        for countryName in set(countryNames):
            ...
            evt = OsintFootprintsEvent("COUNTRY_NAME", countryName, self.__name__, event)
