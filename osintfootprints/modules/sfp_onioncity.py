...
class sfp_onioncity(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for link in darknet_links:
            ...
            if self.opts['fetchlinks']:
                ...
                evt = OsintFootprintsEvent("DARKNET_MENTION_URL", torlink, self.__name__, event)
                self.notifyListeners(evt)
                ...
                evt = OsintFootprintsEvent("DARKNET_MENTION_CONTENT", "..." + data + "...",
                                      self.__name__, evt)
                self.notifyListeners(evt)
            else:
                evt = OsintFootprintsEvent("DARKNET_MENTION_URL", torlink, self.__name__, event)
