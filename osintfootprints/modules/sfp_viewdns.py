...
class sfp_viewdns(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        for domain in set(myres):
            ...
            if eventName == "EMAILADDR":
                e = OsintFootprintsEvent("AFFILIATE_INTERNET_NAME", domain, self.__name__, event)
                ...
                e = OsintFootprintsEvent("CO_HOSTED_SITE", domain, self.__name__, event)
                self.notifyListeners(e)
