...
class sfp_junkfiles(OsintFootprintsPlugin):
    ...
    def checkValidity(self, junkUrl):
        ...
        res = self.sf.fetchUrl(fetch, headOnly=True,
                               ...
                               verify=False)
        if res['code'] != "404":
            host = OsintFootprintsHelpers.urlBaseUrl(junkUrl)
    ...
    def handleEvent(self, event):
        ...
        host = OsintFootprintsHelpers.urlBaseUrl(eventData)
            ...
            if "." + ext + "?" in eventData or "." + ext + "#" in eventData or \
                ...
                for x in self.opts['fileexts']:
                    ...
                    if res['code'] == "200":
                        ...
                        evt = OsintFootprintsEvent("JUNK_FILE", fetch, self.__name__, event)
                        self.notifyListeners(evt)

        base = OsintFootprintsHelpers.urlBaseDir(eventData)
