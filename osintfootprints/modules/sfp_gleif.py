...
class sfp_gleif(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName == "LEI":
            ...
            for record in res:
                ...
                lei = data.get('id')
                if not OsintFootprintsHelpers.validLEI(lei):
                    continue
        ...
        for lei in set(leis):
            ...
            e = OsintFootprintsEvent("LEI", lei, self.__name__, event)
            self.notifyListeners(e)
            ...
            if legal_name:
                ...
                if entity_name:
                    e = OsintFootprintsEvent("COMPANY_NAME", entity_name, self.__name__, event)
                    self.notifyListeners(e)
            ...
            for address in set(addresses):
                e = OsintFootprintsEvent("PHYSICAL_ADDRESS", address, self.__name__, event)
                self.notifyListeners(e)
