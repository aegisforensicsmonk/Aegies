...
class sfp_crxcavator(OsintFootprintsPlugin):
    ...
    def handleEvent(self, event):
        ...
        evt = OsintFootprintsEvent('RAW_RIR_DATA', json.dumps(results), self.__name__, event)
        ...
        for result in results:
            ...
            evt = OsintFootprintsEvent('RAW_RIR_DATA', json.dumps(extensions), self.__name__, event)
            self.notifyListeners(evt)
            ...
            for extension in extensions:
                ...
                evt = OsintFootprintsEvent('APPSTORE_ENTRY', app_data, self.__name__, event)
                self.notifyListeners(evt)
