# test_osintfootprintsdb.py
import pytest
import unittest

from osintfootprints import OsintFootprintsDb, OsintFootprintsEvent


@pytest.mark.usefixtures
class TestOsintFootprintsDb(unittest.TestCase):
    """
    Test OsintFootprintsDb
    """
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    OsintFootprintsDb(invalid_type)
    ...
    def test_init_argument_opts_with_empty_key___database_value_should_raise_ValueError(self):
        ...
        with self.assertRaises(ValueError):
            ...
            OsintFootprintsDb(opts)

    def test_init_should_create_OsintFootprintsDb_object(self):
        """
        Test __init__(self, opts, init=False)
        """
        sfdb = OsintFootprintsDb(self.default_options, False)
        self.assertIsInstance(sfdb, OsintFootprintsDb)
    ...
    def test_scanInstanceCreate_argument_instanceId_of_invalid_type_should_raise_TypeError(self):
        ...
        scan_name = ""
        scan_target = "osintfootprints.net"
        invalid_types = [None, list(), dict()]
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
    ...
    def test_scanEventStore_should_store_a_scan_event(self):
        ...
        module = ''
        source_event = ''
        event = OsintFootprintsEvent(event_type, event_data, module, source_event)
        instance_id = "example instance id"
