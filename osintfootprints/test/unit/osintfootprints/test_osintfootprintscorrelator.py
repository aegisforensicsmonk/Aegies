# test_osintfootprintscorrelator.py
import unittest

from osintfootprints import OsintFootprintsCorrelator, OsintFootprintsDb


class TestOsintFootprintsCorrelator(unittest.TestCase):
    """
    Test OsintFootprintsCorrelator
    """
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    OsintFootprintsCorrelator(invalid_type, {})
    ...
    def test_init_argument_ruleset_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    OsintFootprintsCorrelator(None, invalid_type)
