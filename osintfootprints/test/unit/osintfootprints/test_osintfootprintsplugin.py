# test_osintfootprintsplugin.py
import pytest
import unittest

from sflib import OsintFootprints
from osintfootprints import OsintFootprintsDb, OsintFootprintsEvent, OsintFootprintsPlugin, OsintFootprintsTarget


@pytest.mark.usefixtures
class TestOsintFootprintsPlugin(unittest.TestCase):
    """
    Test OsintFootprints
    """
    ...
    def test_init(self):
        ...
        Test __init__(self)
        """
        sfp = OsintFootprintsPlugin()
        self.assertIsInstance(sfp, OsintFootprintsPlugin)
    ...
    def test_setTarget_should_set_a_target(self):
        ...
        target = OsintFootprintsTarget("osintfootprints.net", "INTERNET_NAME")
        sfp.setTarget(target)

        get_target = sfp.getTarget().targetValue
        self.assertIsInstance(get_target, str)
        self.assertEqual("osintfootprints.net", get_target)
    ...
    def test_set_dbhargument_dbh_should_set_database_handle(self):
        ...
        sfp.setDbh(sfdb)
        self.assertIsInstance(sfp.__sfdb__, OsintFootprintsDb)
