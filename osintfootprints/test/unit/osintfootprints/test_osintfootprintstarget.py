# test_osintfootprintstarget.py
import unittest

from osintfootprints import OsintFootprintsTarget


class TestOsintFootprintsTarget(unittest.TestCase):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    OsintFootprintsTarget(invalid_type, target_type)
    ...
    def test_init_argument_targetType_invalid_type_should_raise_TypeError(self):
        ...
        for invalid_type in invalid_types:
            with self.subTest(invalid_type=invalid_type):
                with self.assertRaises(TypeError):
                    OsintFootprintsTarget(target_value, invalid_type)

    def test_init_argument_targetType_invalid_should_raise_ValueError(self):
        target_value = 'example target value'
        with self.assertRaises(ValueError):
            OsintFootprintsTarget(target_value, 'invalid target type')
    ...
    def test_init_supported_target_types(self):
        ...
        for target_type in self.valid_target_types:
            with self.subTest(target_type=target_type):
                ...
                self.assertIsInstance(target, OsintFootprintsTarget)
    ...
    def test_matches_argument_includeParents_true_with_matching_target_parent_domain_should_return_True(self):
        parent_domain = 'osintfootprints.net'
