# test_osintfootprintscli.py
import io
import pytest
import sys
import unittest

from sfcli import OsintFootprintsCli


@pytest.mark.usefixtures
class TestOsintFootprintsCli(unittest.TestCase):
    """
    Test TestOsintFootprintsCli
    """
    ...
    def test_do_debug_should_toggle_debug(self):
        ...
        """
        sfcli = OsintFootprintsCli(self.cli_default_options)
