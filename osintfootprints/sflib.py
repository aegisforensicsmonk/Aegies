...
# -------------------------------------------------------------------------------
# Name:         sflib
# Purpose:      Common functions used by OsintFootprints modules.
#
...
class OsintFootprints:
    """OsintFootprints

    Attributes:
        dbh (OsintFootprintsDb): database handle
        scanId (str): scan ID this instance of OsintFootprints is being used in
    ...
    def __init__(self, options: dict) -> None:
        """Initialize OsintFootprints object.
    ...
    def dbh(self):
        ...
        Returns:
            OsintFootprintsDb: database handle
        """
        return self._dbh
    ...
    def scanId(self, scanId: str) -> str:
        """Set the scan ID this instance of OsintFootprints is being used in.
    ...
    def cachePut(self, label: str, data: str) -> None:
        ...
        cacheFile = OsintFootprintsHelpers.cachePath() + "/" + pathLabel
    ...
    def configSerialize(self, opts: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): Dictionary of OsintFootprints configuration options
    ...
    def configUnserialize(self, opts: dict, referencePoint: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): OsintFootprints configuration options
    ...
    def urlFQDN(self, url: str) -> str:
        ...
        baseurl = OsintFootprintsHelpers.urlBaseUrl(url)
        if '://' in baseurl:
            count = 2
        else:
            count = 0
    ...
    def fetchUrl(
        ...
        if sizeLimit or headOnly:
            ...
            if newloc.startswith("/") or newloc.startswith("../"):
                newloc = OsintFootprintsHelpers.urlBaseUrl(url) + newloc
